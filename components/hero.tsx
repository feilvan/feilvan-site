  ...
  return (
    <div className="h-screen -mt-0">
      <div className="flex flex-col justify-center h-full overflow-y-visible overflow-x-hidden lg:overflow-x-visible relative">
        <div className="relative -top-[22rem] text-gray-200 dark:text-gray-800">
        ...
        <div className="relative top-0 left-6">
          ...
          <div className="flex flex-col sm:flex-row space-y-1 sm:space-y-0 space-x-0 sm:space-x-8 mt-4 sm:mt-8 tracking-widest font-inter font-light text-sm">
      ...
      <FaCaretDown
        size={25}
        className="relative bottom-32 mx-auto text-gray-400 dark:text-gray-600 hover:text-gray-600 hover:dark:text-gray-400 transition"
      />
    </div>
  );
}
